...
describe ('Calculates the total of two multiplied numbers', function(){
    it('should return a total of the two numbers multiplied', function(){
        ...
        var actual = multiplyTwoNumbers(numOneToTest, numTwoToTest);
...
describe ('Calculates the total of two subtracted numbers', function(){
    it('should return a total of the two numbers subtracted', function(){
        ...
        var actual = subtractTwoNumbers(numOneToTest, numTwoToTest);
...
describe ('Calculates the total of two added numbers', function(){
    it('should return a total of the two numbers added', function(){
        ...
        var actual = addTwoNumbers(numOneToTest, numTwoToTest);
